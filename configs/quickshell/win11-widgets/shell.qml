          ...
          ColumnLayout {
            ...
            Rectangle {
              ...
              ColumnLayout {
                ...
                RowLayout {
                  ...
                  Text { text: widgetsWindow.volumeVal + "%"; font.family: "Segoe UI"; font.pixelSize: 10; color: "#ffffff"; Layout.preferredWidth: 32 }
                }
                ...
                RowLayout {
                  ...
                  Text { text: widgetsWindow.brightnessVal + "%"; font.family: "Segoe UI"; font.pixelSize: 10; color: "#ffffff"; Layout.preferredWidth: 32 }
                }
              }
            }
              ...
              Rectangle {
                ...
                ColumnLayout {
                  ...
                  RowLayout {
                    Layout.fillWidth: true
                    spacing: 4
                    Text { text: "MSFT"; color: "#ffffff"; font.family: "Segoe UI"; font.pixelSize: 11; font.weight: Font.Bold; Layout.fillWidth: true; elide: Text.ElideRight }
                    Text { text: "$448.20"; color: "#ffffff"; font.family: "Segoe UI"; font.pixelSize: 10; font.weight: Font.DemiBold }
                  ...
                  RowLayout {
                    Layout.fillWidth: true
                    spacing: 4
                    Text { text: "AAPL"; color: "#ffffff"; font.family: "Segoe UI"; font.pixelSize: 11; font.weight: Font.Bold; Layout.fillWidth: true; elide: Text.ElideRight }
                    Text { text: "$224.50"; color: "#ffffff"; font.family: "Segoe UI"; font.pixelSize: 10; font.weight: Font.DemiBold }
                  ...
                  RowLayout {
                    Layout.fillWidth: true
                    spacing: 4
                    Text { text: "NVDA"; color: "#ffffff"; font.family: "Segoe UI"; font.pixelSize: 11; font.weight: Font.Bold; Layout.fillWidth: true; elide: Text.ElideRight }
                    Text { text: "$128.90"; color: "#ffffff"; font.family: "Segoe UI"; font.pixelSize: 10; font.weight: Font.DemiBold }
            ...
            Rectangle {
              ...
              ColumnLayout {
                ...
                RowLayout {
                  Layout.fillWidth: true
                  Text { text: "MICROSOFT TO-DO"; color: Qt.rgba(1, 1, 1, 0.55); font.family: "Segoe UI"; font.pixelSize: 10; font.weight: Font.Bold; Layout.fillWidth: true; elide: Text.ElideRight }
                ...
                RowLayout {
                  ...
                  Text {
                    text: "Deploy Quickshell Windows 11 widgets"
                    color: "#ffffff"
                    font.family: "Segoe UI"
                    font.pixelSize: 12
                    Layout.fillWidth: true
                ...
                RowLayout {
                  ...
                  Text {
                    text: "Review Omarchy Undercover v2.5 documentation"
                    color: "#ffffff"
                    font.family: "Segoe UI"
                    font.pixelSize: 12
                    Layout.fillWidth: true
                ...
                RowLayout {
                  ...
                  Text { text: "⬜"; font.pixelSize: 12 }
                  Text {
                    text: "Configure multi-monitor taskbar mirrors"
                    color: "#ffffff"
                    font.family: "Segoe UI"
                    font.pixelSize: 12
                    Layout.fillWidth: true
            ...
            Rectangle {
              ...
              ColumnLayout {
                ...
                RowLayout {
                  Layout.fillWidth: true
                  Text { text: "TOP STORIES • MSN NEWS"; color: Qt.rgba(1, 1, 1, 0.55); font.family: "Segoe UI"; font.pixelSize: 10; font.weight: Font.Bold; Layout.fillWidth: true; elide: Text.ElideRight }
                ...
                RowLayout {
                  ...
                  ColumnLayout {
                    ...
                    spacing: 2
                    Text {
                      text: "Omarchy Undercover Releases Full Quickshell Suite"
                      color: "#ffffff"
                      font.family: "Segoe UI"
                      font.pixelSize: 12
                      font.weight: Font.Bold
                    ...
                    Text {
                      text: "Pure QML widgets and 60fps animations arrive for Hyprland — TechNews • 15m ago"
                      color: Qt.rgba(1, 1, 1, 0.6)
                      font.family: "Segoe UI"
                      font.pixelSize: 10
                      Layout.fillWidth: true
                ...
                RowLayout {
                  ...
                  ColumnLayout {
                    ...
                    spacing: 2
                    Text {
                      text: "Next-Gen AI Desktop Experiences Launch on Wayland"
                      color: "#ffffff"
                      font.family: "Segoe UI"
                      font.pixelSize: 12
                      font.weight: Font.Bold
                    ...
                    Text {
                      text: "Fluent design and mica glassmorphism revolutionize Linux desktops — TheVerge • 1h ago"
                      color: Qt.rgba(1, 1, 1, 0.6)
                      font.family: "Segoe UI"
                      font.pixelSize: 10
                      Layout.fillWidth: true
